...
import MainCourseImage from "../../Food_Assets/assets/menu/menu1.jpeg";
import MainCourseImage1 from "../../Food_Assets/assets/menu/menu2.jpeg";
import MainCourseImage2 from "../../Food_Assets/assets/menu/menu3.jpeg";
import MainCourseImage3 from "../../Food_Assets/assets/menu/menu4.jpeg";
import "../../Styles/Nashta.css";
import { useNavigate } from 'react-router-dom'; 
import Header from '../../Components/Layout/Header';

function Nashta({ addToCart }) {
