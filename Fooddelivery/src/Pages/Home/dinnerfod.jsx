...
import MainCourseImage from "../../Food_Assets/assets/menu/menu5.jpeg";
import MainCourseImage1 from "../../Food_Assets/assets/menu/menu6.jpeg";
import MainCourseImage2 from "../../Food_Assets/assets/menu/menu7.jpeg";
import MainCourseImage3 from "../../Food_Assets/assets/menu/menu8.jpeg";
import "../../Styles/Nashta.css";
import { useNavigate } from 'react-router-dom'; 
import Header from '../../Components/Layout/Header';

function dinnerfod({ addToCart }) {
